...
ggsave(paste0(plot_dir, "/exp2_pretrain_studyRT.pdf"), width = 4, height = 3.5)
...
pretrain_test <- read.csv(paste0(data_dir, "/exp2_pretrain_test_clean.csv"), stringsAsFactors = F)
...
ggsave(paste0(plot_dir, "/exp2_pretrain_testAcc.pdf"), width = 5, height = 3.5)
...
enc <- read.csv(paste0(data_dir, "/exp2_enc_clean.csv"), stringsAsFactors = F)

# 1. encoding RTs for pred v. rand events
...
ggsave(paste0(plot_dir, "/exp2_reconAcc.pdf"), width = 4.5, height = 3.5)
...
ggsave(paste0(plot_dir, "/exp2_reconAcc_event.pdf"), width = 4.5, height = 3.5)
...
ggsave(paste0(plot_dir, "/exp2_reconAcc_seqpos.pdf"), width = 4.5, height = 3.5)
...
ggsave(paste0(plot_dir, "/exp2_spatialAcc.pdf"), width = 4.5, height = 3.5)
...
ggsave(paste0(plot_dir, "/exp2_spatialAcc_seqpos.pdf"), width = 5, height = 3.5)
